...
export const patient1Id = "bc2f8328-72d0-44bc-aa25-30a240814ada";
export const doctor1Id = "26efe3cc-1b2a-45e0-aebd-42794d970458";
export const doctor2Id = "83610b9b-1ced-48da-acfe-2925caa0468c";
export const doctor3Id = "17620195-91ec-4578-b8ea-407e8bc7d885";
 
// These IDs are placeholders. In a real seed, you'd get the actual appointment IDs after creation.
 
export const appointmentIds = {
  apt1: "bd7445ce-a58d-47a5-9411-30918f5ee0fe",
  apt2: "7ace2c20-6c92-4037-a099-e25b032a4858",
  apt3: "475edb0f-f7a4-47c4-be2c-dc59b1cb473e",
  apt4: "0e9019b0-4f52-4738-9a55-4422869de458",
  apt5: "9ac7bc34-0c25-4411-a2d1-f41b6243a361",
  apt6: "921df243-72a0-4144-809f-a8b5a9f1fbaa",
  apt7: "879f644c-5899-45b7-8ff7-a5734f172317",
  apt8: "fe114285-e448-46f2-9050-4ec77d465a24",
  apt9: "ec8d0d6f-e276-4e09-a9ab-2712ad28259f",
  apt10: "1ed7a0e0-51aa-480e-bd6e-c5d7b29222ca",
};
